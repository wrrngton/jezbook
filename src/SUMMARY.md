...
- [Elasticsearch](./courses/elasticsearch/README.md)
    ...
    - [elastic-stack-elk.md](./courses/elasticsearch/elastic-stack-elk.md)
    - [opensearch-vs-es.md](./courses/elasticsearch/opensearch-vs-es.md)
    - [hosting-options.md](./courses/elasticsearch/hosting-options.md)
    - [useful-commands.md](./courses/elasticsearch/useful-commands.md)
    - [elasticsearch-architecture.md](./courses/elasticsearch/elasticsearch-architecture.md)
    - [debugging.md](./courses/elasticsearch/debugging.md)
    - [CURL-queries.md](./courses/elasticsearch/CURL-queries.md)
    ...
    - [managing data](./courses/elasticsearch/managing-data.md)
    - [routing](./courses/elasticsearch/routing.md)
